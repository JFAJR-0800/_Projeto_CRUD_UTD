        ...
        <div class="card-body">
            ...
            <form action="<?=Config::urlBase();?>/controllers/Produtos.php" method="POST" class="form-horizontal mt-4" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label"><span class="iconify" data-icon="" style="color: #198754;"></span> Nome do Produto </label>
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label"><span class="iconify" data-icon="" style="color: #198754;"></span> Codigo do Produto </label>
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label"><span class="iconify" data-icon="" style="color: #198754;"></span> Preço do Produto </label>
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label"><span class="iconify" data-icon=""  style="color: #198754;"></span> Estoque do Produto </label>
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label"><span class="iconify" data-icon=""  style="color: #198754;"></span> Ativar? </label>
